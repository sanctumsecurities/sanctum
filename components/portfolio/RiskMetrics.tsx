...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div>
      <div style={{ fontSize: 10, color: COLORS.textMuted, fontFamily: MONO, letterSpacing: '0.15em' }}>
        {label}
      </div>
      <div style={{ fontSize: 19, color: COLORS.text, fontFamily: MONO, marginTop: 4 }}>
        {value}
      </div>
    </div>
  )
  ...
  return (
    <div style={{
      ...
      <div style={{ paddingTop: 10, borderTop: `1px solid ${COLORS.divider}` }}>
        ...
        <div style={{ fontSize: 14, color: COLORS.text, fontFamily: MONO, marginTop: 4 }}>
